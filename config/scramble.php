...
return [
    ...
    'info' => [
         ...
         */
        'description' => "API REST de KaniaPicks, plateforme de marchés prédictifs (Oui/Non) : marchés, ordres, positions, portefeuille, dépôts CinetPay et résolution des marchés.",
    ],
